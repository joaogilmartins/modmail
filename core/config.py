...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_close_response": "{closer.mention} fechou este ticket. Obrigado por contactar o suporte da nossa rede. Sinta-se à vontade para criar um novo ticket qualquer momento.",
        "thread_self_close_response": "{closer.mention} fechou este ticket. Obrigado por contactar o suporte da nossa rede. Sinta-se à vontade para criar um novo ticket a qualquer momento.",
        "thread_move_title": "Ticket movido",
        "thread_move_notify": False,
        "thread_move_notify_mods": False,
        "thread_move_response": "Este ticket foi movida para análise futura dos membros da administração. ***Isto pode criar uma variação do tempo de espera.***",
        ...
        "disabled_current_thread_response": "Não estamos aceitandos novas mensagens.",
        ...
        "confirm_thread_creation_title": "Confirme a criação de um novo ticket",
        "confirm_thread_response": "Reaja para confirmar a criação do novo ticket. Ao criar o ticket os moderadores serão contactados diretamente",
