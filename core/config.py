...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_move_response": "Esta thread foi movida para análise futura dos membros da administração. ***Isto pode criar uma variação do tempo de espera.***",
        ...
        "confirm_thread_creation_title": "Confirme a criação de uma nova thread",
