...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_auto_close_response": "Esta thread foi fechada devido a inatividade..",
        ...
        "thread_creation_footer": "Sua mensagem foi enviada",
        "thread_contact_silently": False,
        "thread_self_closable_creation_footer": "Clique no cadeado para fechar a thread.",
        "thread_creation_title": "Thread criada",
        "thread_close_footer": "Responder a esta mensagem irá criar uma nova menssagem",
        "thread_close_title": "Thread fechada,
        "thread_close_response": "{closer.mention} fechou essa thread. Obrigado por contactar o suporte da nossa rede. Qualquer dúvida que surja, sinta-se à vontade para criar uma nova thread,",
        "thread_self_close_response": "Você fechou essa thread.",
        "thread_move_title": "Thread movida",
        "thread_move_notify": False,
        "thread_move_notify_mods": False,
        "thread_move_response": "Esta thread foi movida.",
        "cooldown_thread_title": "Mensagem não enviada",
        "cooldown_thread_response": "Você deve esperar por {delta} antes de poder contactar-nos outra vez.",
        "disabled_new_thread_title": "Não enviado",
        "disabled_new_thread_response": "Não estamos aceitando novas threads.",
        "disabled_new_thread_footer": "Por favor tente mais tarde...",
        "disabled_current_thread_title": "Não enviado",
        "disabled_current_thread_response": "Nós não estamos aceitando mais mensagens.",
        ...
        "confirm_thread_creation_title": "Confirme a criação da thread",
        "confirm_thread_response": "Reaja para confirmar a criação da thread. Ao criar a thread os moderadores serão contactados diretamente.",
